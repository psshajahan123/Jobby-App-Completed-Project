      ...
      <div className="job-details-content-container">
        <div className="job-details">
          ...
          <div className="location-package-container">
            <div className="location-and-type-container">
              <div className="location-and-icon-container">
                ...
                <p className="location-texts">{location}</p>
              </div>
              <div className="location-and-icon-container">
                <BsFillBriefcaseFill className="location-icon" />
                <p className="location-texts">{employmentType}</p>
              </div>
            </div>
          ...
          <div className="description-visit-link-container">
            <h1 className="job-description-heading-b">Description</h1>
            <a href={companyWebsiteUrl} className="company-link">
              Visit
              <FiExternalLink className="external-link-logo" />
            </a>
          </div>
          <p className="job-description-content-b">{jobDescription}</p>
